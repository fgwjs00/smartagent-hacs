...
SmartAgent Home Assistant 集成通过 HACS 更新。用户看到的公开版本从 `Beta 0.0.1` 开始。
...
The SmartAgent Home Assistant integration is updated through HACS. The public release line starts from `Beta 0.0.1`.

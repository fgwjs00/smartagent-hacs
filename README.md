...
SmartAgent Home Assistant 集成通过 HACS 更新。当前公开版本为 `Beta 0.0.5`。
...
The SmartAgent Home Assistant integration is updated through HACS. The current public release is `Beta 0.0.5`.

...
`;return typeof l=="function"&&l(null,I),I},Se}var yi;function Ps(){if(yi)return st;yi=1;const n=cs(),t=Cs(),i=As(),s=ks();function e(r,o,l,a,d){const h=[].slice.call(arguments,1),c=h.length,p=typeof h[c-1]=="function";if(!p&&!n())throw new Error("Callback required as last argument");if(p){if(c<2)throw new Error("Too few arguments provided");c===2?(d=l,l=o,o=a=void 0):c===3&&(o.getContext&&typeof d>"u"?(d=a,a=void 0):(d=a,a=l,l=o,o=void 0))}else{if(c<1)throw new Error("Too few arguments provided");return c===1?(l=o,o=a=void 0):c===2&&!o.getContext&&(a=l,l=o,o=void 0),new Promise(function(u,m){try{const f=t.create(l,a);u(r(f,o,a))}catch(f){m(f)}})}try{const u=t.create(l,a);d(null,r(u,o,a))}catch(u){d(u)}}return st.create=t.create,st.toCanvas=e.bind(null,i.render),st.toDataURL=e.bind(null,i.renderToDataURL),st.toString=e.bind(null,function(r,o,l){return s.render(r,l)}),st}var Ts=Ps();const Rs=ls(Ts);var Ms=Object.defineProperty,Is=Object.getOwnPropertyDescriptor,qt=(n,t,i,s)=>{for(var e=s>1?void 0:s?Is(t,i):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(e=(s?o(t,i,e):o(e))||e);return s&&e&&Ms(t,i,e),e};let ct=class extends D{constructor(){super(...arguments),this.variant="frosted",this.state="off",this.interactive=!1}render(){return g`
  ...
  `;Vt([T({type:Number})],dt.prototype,"value",2);Vt([T({type:String})],dt.prototype,"label",2);Vt([M()],dt.prototype,"_isDragging",2);dt=Vt([N("glass-slider")],dt);var Ns=Object.defineProperty,Fs=Object.getOwnPropertyDescriptor,Re=(n,t,i,s)=>{for(var e=s>1?void 0:s?Fs(t,i):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(e=(s?o(t,i,e):o(e))||e);return s&&e&&Ns(t,i,e),e};let wt=class extends D{constructor(){super(...arguments),this.rooms=[],this.activeRoom=""}render(){return g`
  ...
  `;L([T({type:Object})],Et.prototype,"device",2);L([T({type:Boolean})],Et.prototype,"isAiControlled",2);Et=L([N("light-card")],Et);let St=class extends D{constructor(){super(...arguments),this.device={},this.isAiControlled=!1}render(){const n=this.device.state!=="off",t=this.device.attributes.temperature||26,i=ut(this.device.icon,"climate");return g`
  ...
  `;L([T({type:Object})],St.prototype,"device",2);L([T({type:Boolean})],St.prototype,"isAiControlled",2);St=L([N("climate-card")],St);let $t=class extends D{constructor(){super(...arguments),this.device={},this.isAiControlled=!1}render(){const n=this.device.attributes.current_position||0,t=n>0,i=ut(this.device.icon,"cover");return g`
  ...
  `;L([T({type:Object})],Ct.prototype,"device",2);L([T({type:Boolean})],Ct.prototype,"isAiControlled",2);Ct=L([N("generic-device-card")],Ct);let ht=class extends D{constructor(){super(...arguments),this.scene={},this.isAiRecommended=!1,this.reason=""}render(){const n=ut(this.scene.icon,"scene");return g`
      <glass-card 
        interactive 
  ...
  `;Di([T({type:Array})],Nt.prototype,"stats",2);Nt=Di([N("energy-chart")],Nt);var Qs=Object.defineProperty,Zs=Object.getOwnPropertyDescriptor,zi=(n,t,i,s)=>{for(var e=s>1?void 0:s?Zs(t,i):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(e=(s?o(t,i,e):o(e))||e);return s&&e&&Qs(t,i,e),e};let Ft=class extends D{constructor(){super(...arguments),this.events=[]}render(){return!this.events||this.events.length===0?g`
        <div class="empty-state">
  ...
  `;zi([T({type:Array})],Ft.prototype,"events",2);Ft=zi([N("frigate-events-panel")],Ft);var tn=Object.defineProperty,en=Object.getOwnPropertyDescriptor,Yt=(n,t,i,s)=>{for(var e=s>1?void 0:s?en(t,i):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(e=(s?o(t,i,e):o(e))||e);return s&&e&&tn(t,i,e),e};let Lt=class extends D{constructor(){super(...arguments),this.device={}}render(){const n=this.device.attributes||{},t=this.device.brightness!==void 0?this.device.brightness:n.brightness?Math.round(n.brightness/255*100):0,i=n.color_temp_kelvin||(n.color_temp?Math.round(1e6/n.color_temp):null),s=n.min_color_temp_kelvin||(n.max_mireds?Math.round(1e6/n.max_mireds):2700),e=n.max_color_temp_kelvin||(n.min_mireds?Math.round(1e6/n.min_mireds):6500),r=i??Math.round((s+e)/2),o=Math.min(100,Math.max(0,Math.round((r-s)/(e-s)*100))),l=n.supported_color_modes||[],a=l.includes("color_temp"),d=l.some(c=>["hs","rgb","xy","rgbw","rgbww"].includes(c)),h=[{name:"暖光",color:"#FFB347",k:2700},{name:"自然",color:"#FFE0B2",k:3500},{name:"阅读",color:"#FFF5DC",k:4e3},{name:"冷白",color:"#E8F4FD",k:5e3},{name:"日光",color:"#E3F2FD",k:6e3}].filter(c=>c.k>=s&&c.k<=e);return g`
      <div class="container">
        <!-- 亮度调节 -->
        <div class="section">
          <div class="value-display">
    ...
    `}_call(n,t){this.dispatchEvent(new CustomEvent("service-call",{bubbles:!0,composed:!0,detail:{domain:"light",service:n,data:{...t,entity_id:this.device.id}}}))}};Lt.styles=B`
    :host {
      display: block;
      width: 100%;
      height: 100%;
  ...
  `;Yt([T({type:Object})],Lt.prototype,"device",2);Lt=Yt([N("light-detail-panel")],Lt);let Ut=class extends D{constructor(){super(...arguments),this.device={}}render(){const n=this.device.state,t=this.device.attributes.fan_mode||"auto";return g`
      <div class="container">
        <div class="section">

...
class InferenceMixin:
    ...
    async def _call_ai_engine(self, context: str, trigger: str, is_voice: bool = False, one_off_prompt: str = "", bundle: dict | None = None) -> dict | None:
        ...
        if bundle:
            ...
            space_runtime_summary = bundle.get("space_runtime_summary", "")
            device_impact_summary = bundle.get("device_impact_summary", "")
            ...
            if space_runtime_summary:    p2_parts.append(space_runtime_summary)
            if device_impact_summary:   p2_parts.append(device_impact_summary)
            ...
            if any(layered_memory):
                p2_parts.extend([part for part in layered_memory if part])
